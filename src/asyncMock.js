const products = [
  {
    ...
    description:
      "Powerful smartphone with latest generation camera and AMOLED display.",
    stock: 50,
  },
  {
    id: "2",
    ...
    description:
      "Ultrathin laptop with InfinityEdge display and high-performance processor.",
    stock: 30,
  },
  {
    id: "3",
    ...
    description:
      "Wireless earphones with noise cancellation and superior sound quality.",
    stock: 40,
  },
  {
    id: "4",
  ...
  },
  {
    ...
    description:
      "Tablet with Liquid Retina display, powerful A14 Bionic chip, and Apple Pencil support.",
    stock: 25,
  },
  {
    id: "6",
    ...
    description:
      "Mirrorless camera with high-resolution sensor and 8K recording capability.",
    stock: 10,
  },
  {
    id: "7",
    ...
    description:
      "Portable speaker with long-lasting battery and water resistance.",
    stock: 35,
  },
  {
    id: "8",
  ...
  },
  {
    ...
    description:
      "Laser printer with wireless connectivity and fast printing speed.",
    stock: 18,
  },
  {
    id: "10",
    ...
    description:
      "Mechanical keyboard with customizable RGB backlighting and Cherry MX switches.",
    stock: 22,
  },
  {
    id: "11",
    ...
    description:
      "High-speed router compatible with Wi-Fi 6 for faster connectivity.",
    stock: 12,
  },
  {
    id: "12",
    ...
    description:
      "Lightweight gaming mouse with HERO sensor and customizable design.",
    stock: 30,
  },
  {
    id: "13",
    ...
    description:
      "Smart air conditioner with voice control and personalized scheduling.",
    stock: 15,
  },
  {
    id: "14",
    ...
    description:
      "High-capacity external battery with fast charging for mobile devices.",
    stock: 40,
  },
  {
    id: "15",
    ...
    description:
      "Blu-ray player with 4K playback capability and high-resolution audio.",
    stock: 25,
  },
  {
    id: "16",
    ...
    description:
      "Robot vacuum with advanced cleaning system and automatic emptying station.",
    stock: 8,
  },
  {
    id: "17",
    ...
    description:
      "Projector with 4K PRO-UHD technology and HDR playback capability.",
    stock: 10,
  },
  {
    id: "18",
    ...
    description:
      "Webcam with Full HD resolution and automatic light correction.",
    stock: 28,
  },
  {
    id: "19",
...
export const dataCarrousel = [
  {
    id: 1,
    img: "src/assets/imageCarrouselHome/banner-announcing-mega-discount-half-260nw-1962489325.jpg",
  },
  {
    id: 2,
    img: "src/assets/imageCarrouselHome/fechas-ecommerce-descuentos.jpg",
  },
  {
    id: 3,
    img: "src/assets/imageCarrouselHome/istockphoto-1206800961-612x612.jpg",
  },
  {
    id: 4,
    img: "src/assets/imageCarrouselHome/panoramic-shot-of-toy-box-on-laptop-keyboard-near-2022-12-16-17-04-14-utc-scaled.jpg",
  },
];
