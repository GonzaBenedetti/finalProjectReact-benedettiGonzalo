    ...
    <footer className="footerMain">
      <div className="containerFooter">
        ...
        <ul>
          ...
          <NavLink className="linkFooter" to="/shop">
            Shop
          </NavLink>
          <NavLink className="linkFooter" to="/about">
            About
          </NavLink>
          <NavLink className="linkFooter" to="/help">
            Help
          </NavLink>
        </ul>
        <ul>
          <h4>Company</h4>
          <NavLink className="linkFooter" to="/the-company">
            The Company
          </NavLink>
          <NavLink className="linkFooter" to="/careers">
            Careers
          </NavLink>
